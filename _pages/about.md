...
As an advocate for social justice, I’m passionate about AI applications that drive social impact. At the [Applied Perception Lab](https://ap-lab.ca/), I research AI, ethics, and EDI, developing frameworks to address societal challenges and promote responsible healthcare technology. I’m also conducting research in Deep Learning for Conversational AI at [Mila](https://mila.quebec/en/directory/nadine-el-mufti), focusing on early disease detection through speech analysis to improve diagnostic accuracy.
