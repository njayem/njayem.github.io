...
As an advocate for social justice, I am passionate about working on AI applications that create meaningful social impact. <strong>Currently</strong>, I am conducting research on the intersections of AI, ethics, and Equity, Diversity, and Inclusion (EDI) at the [Applied Perception Lab](https://ap-lab.ca/). My work focuses on developing frameworks to address societal challenges and guide the future of responsible technology in healthcare. In parallel, I am pursuing novel research in Deep Learning for Conversational AI at [Mila](https://mila.quebec/en/directory/nadine-el-mufti), focusing on detecting pathologies from speech to improve diagnostic accuracy in healthcare. 
...
<table border="1">
  <tr>
    <td><a href="https://drive.usercontent.google.com/download?id=1UprcfA_F0Ef_xiaKEm3yabpMUPt-_yRp"></a></td>  
    <td><a href="https://drive.usercontent.google.com/download?id=1yY-o43-rQhZp6U_EgoJJ0eNmWLasVja6"></a></td>
    <td><a href="https://drive.usercontent.google.com/download?id=1Dd7GlHn0Lvh_QLhknM4-M-JPMIoyOsUS"></a></td>
  </tr>
</table>
